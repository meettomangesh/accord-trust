...
* @package vorosa
*/
if( !class_exists('vorosa__Recent_Post') ){
	class vorosa__Recent_Post extends WP_Widget{
		/**
		 * Register widget with WordPress.
		 */
		function __construct(){
			$widget_options = array(
				'description' 					=> esc_html__('vorosa_ blog recent post here', 'vorosa'), 
				'customize_selective_refresh' 	=> true,
			);
			parent:: __construct('vorosa__Recent_Post', esc_html__( 'Vorosa: Recent Post', 'vorosa'), $widget_options );
		}
		/**
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Posts','vorosa' );
				...
				<ul class="sidebar-post">
					...
					while($posts->have_posts()) : $posts->the_post();  ?>
						<li>
			                ...
			                <div class="post-img">
			                    <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'vorosa_recent_post_thumb_size' ); ?></a>
			                </div>
			                <?php endif; ?>
			                <div class="post-text">
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'show_item' )); ?>"><?php echo esc_html__( 'No. of Item of posts to show:','vorosa' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'num_title_word' )); ?>"><?php echo esc_html__( 'Title Word','vorosa' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php echo esc_html__( 'Display post date?','vorosa' ); ?></label>
		</p>
	<?php
		}
	}
...
function vorosa__Recent_Post(){
	register_widget('vorosa__Recent_Post');
}
add_action('widgets_init','vorosa__Recent_Post');