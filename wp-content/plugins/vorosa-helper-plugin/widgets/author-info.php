...
*
**/
if ( !class_exists('vorosa__Author_About_Widget') ) {

	class vorosa__Author_About_Widget extends WP_Widget{

		function __construct(){

			$widget_options = array(

				'description' 					=> esc_html__('This widget show author informations', 'vorosa'), 

				'customize_selective_refresh' 	=> true,

			);

			parent:: __construct('vorosa__Author_About_Widget', esc_html__( 'Vorosa: Author Informations', 'vorosa'), $widget_options );
		...
		public function widget($args, $instance){ 
	        ...
	        <?php echo wp_kses_post( $args['before_widget'] ); ?>
	        	...
	        	<div class="author--info--wrap">
	        		...
	        		<?php if ( !empty($image) ): ?>
	        			<img src="<?php echo esc_url( $image ) ; ?>" alt="<?php esc_attr_e('Author Image', 'vorosa'); ?>">
	        		<?php endif ?>
		            ...
		            <div class="self-info white-bg">
		                ...
		                <div class="blog-social">
		                    ...
		                    <ul>
        						...
        						<li>
        							<a class="youtube" href="<?php echo esc_url( $youtube ); ?>" title="<?php esc_attr__('youtube', 'vorosa'); ?>"><i class="fa fa-youtube"></i></a>
        						</li>

        						<?php endif; if( $linked ): ?>
        						<li>
        							<a class="linked" href="<?php echo esc_url( $linked ); ?>" title="<?php esc_attr__('Linkedin', 'vorosa'); ?>"><i class="fa fa-linkedin"></i></a>
        						</li>

        						<?php endif; if( $pinterest ): ?>
        						<li>
        							<a class="pinterest" href="<?php echo esc_url( $pinterest ); ?>" title="<?php esc_attr__('Pinterest', 'vorosa'); ?>"><i class="fa fa-pinterest"></i></a>
        						</li>

        						<?php endif; if( $instagram ): ?>
        						<li>
        							<a class="instagram" href="<?php echo esc_url( $instagram ); ?>" title="<?php esc_attr__('instagram', 'vorosa'); ?>"><i class="fa fa-instagram"></i></a>
        						</li>
        						<?php endif; ?>
		...
		public function form($instance){ 
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('social_title')); ?>"><?php echo esc_html__('Social Title:' ,'vorosa') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('youtube')); ?>"><?php echo esc_html__('Youtube Link:' ,'vorosa') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php echo esc_html__('Pinterest Link:' ,'vorosa') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('instagram')); ?>"><?php echo esc_html__('Instagram Link:' ,'vorosa') ?></label>
...
function vorosa__Author_About_Widget() {

    register_widget( 'vorosa__Author_About_Widget' );

}

add_action( 'widgets_init', 'vorosa__Author_About_Widget' );