...
add_action('init', 'vorosa_section_title_two'); // Call kc_add_map function ///
if(!function_exists('vorosa_section_title_two')):
	function vorosa_section_title_two(){
		if(function_exists('kc_add_map')): // if kingComposer is active
		kc_add_map(
		    array(
		        'vorosa_section_title_two'  => array( // <-- shortcode tag name
		            'name'        => esc_html__('vorosa Section Title Two',  'vorosa'),
		        ...
		        // .............................................
		         	'General' => array(
		                ...
		                array(
							'name' 	=> 'sec_title_two_box_icon',
							'label' => esc_html__( 'Upload Thumbnail', 'vorosa' ),
							'type' 	=> 'attach_image', 
							'value'	=> plugins_url( 'images/7.png', __FILE__ ),
							
						),
						array(
							'type'					=> 'select',
							'label'					=> esc_html__( 'Icon Size', 'vorosa' ),
							'name'					=> 'sec_title_two_icon_size',
							'options'				=> array(
								'full'				=> 'Full',
								'thumbnail'			=> 'Thumbnail',
								'medium'			=> 'Medium',
 ...
 */
 ...
 if(!function_exists('vorosa_section_title_two_shortcode')){
	function vorosa_section_title_two_shortcode($atts,$content){
	ob_start();
	...
	<div class="<?php echo esc_attr( $extra_class ); ?> <?php echo esc_attr( $custom_css_class ); ?>">
		<div class="section-title section-2 text-center <?php echo esc_attr( $align_value ); ?>">
			<?php if ( isset( $title ) ): ?>
			...
			<div class="icon-img-2">
				<?php echo wp_get_attachment_image($sec_title_two_box_icon, $sec_title_two_icon_size); ?>
			</div>
		</div>
	</div>
	<?php
	...
	add_shortcode('vorosa_section_title_two' ,'vorosa_section_title_two_shortcode');
}