...
add_action('init', 'vorosa_section_title_three'); // Call kc_add_map function ///
if(!function_exists('vorosa_section_title_three')):
	function vorosa_section_title_three(){
		if(function_exists('kc_add_map')): // if kingComposer is active
		kc_add_map(
		    array(
		        'vorosa_section_title_three'  => array( // <-- shortcode tag name
		            'name'        => esc_html__('vorosa Section Title Three',  'vorosa'),
 ...
 */
 ...
 if(!function_exists('vorosa_section_title_three_shortcode')){
	function vorosa_section_title_three_shortcode($atts,$content){
	ob_start();
	...
	add_shortcode('vorosa_section_title_three' ,'vorosa_section_title_three_shortcode');
}