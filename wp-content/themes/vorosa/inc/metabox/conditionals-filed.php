...
* Conditional Fields
*/
if ( ! class_exists( 'theme_name__cmb2_conditionals' ) ) {

	/**
	 * theme_name__cmb2_conditionals Plugin.
	 */
	class theme_name__cmb2_conditionals {
		 ...
		 * @var array
		 */
		protected $theme_name__maybe_required_form_elms = array(
			'list_input',
			'input',
			'textarea',
			'input',
		...
		public function __construct() {
			...
			foreach ( $this->theme_name__maybe_required_form_elms as $element ) {
				add_filter( "cmb2_{$element}_attributes", array( $this, 'theme_name__maybe_set_required_attribute' ), self::PRIORITY );
			}
		}
		 ...
		 * @return array
		 */
		public function theme_name__maybe_set_required_attribute( $args ) {
	...
	if ( ! function_exists( 'cmb2_conditionals_init' ) ) {
		...
		function cmb2_conditionals_init() {
			$cmb2_conditionals = new theme_name__cmb2_conditionals();
		}
	}
