...
?>
<div class="header-area header-five <?php echo esc_attr( $vorosa_header_sticky_class ); ?>">
	<div class="<?php echo esc_attr( $header_widht ); ?>">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				?>
				<div class="header-menu-wrap header-bottom logo-<?php echo esc_attr( $vorosa_logo_position_value ); ?> ">
					...
					<div class="menu-and-search-area">
						<div class="header-menu f-right">
							<div class="header-button search-2">
								<a class="button theme-bg" href="<?php echo esc_url( $vorosa_opt['vorosa_donate_link5'] ); ?>"><?php echo esc_html( $vorosa_opt['vorosa_donate_text'] ); ?></a>
							</div>
						</div>
